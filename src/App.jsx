  ...
  return (
    <div
      style={{
        ...
        width: hov ? 40 : 14, height: hov ? 40 : 14,
        borderRadius: '50%', pointerEvents: 'none',
        transform: 'translate(-50%,-50%)',
        background: hov ? 'rgba(79, 126, 248, 0.12)' : 'rgba(79, 126, 248, 0.45)',
        border: '1.5px solid rgba(79, 126, 248, 0.65)',
    ...
    <nav style={{
      ...
      <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
        ...
        <a
          ...
          style={{
            fontFamily: 'var(--font-mono)', fontSize: 13, fontWeight: 600, padding: '10px 22px',
            border: '1.5px solid var(--accent)', borderRadius: 8, color: 'var(--accent)',
            textDecoration: 'none', letterSpacing: '0.05em',
            transition: 'all 0.2s',
          }}
          onMouseEnter={e => {
            e.target.style.background = 'rgba(79,126,248,0.08)'
            e.target.style.boxShadow = '0 0 20px rgba(79,126,248,0.18)'
          }}
          onMouseLeave={e => {
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: 60, alignItems: 'center' }}>
          <div>
            ...
            <div className="animate-fade-up delay-200" style={{ marginBottom: 36, height: 48, display: 'flex', alignItems: 'center' }}>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 24, color: 'var(--accent)', fontWeight: 600 }}>
                &gt; {typed}<span className="animate-blink" style={{ borderLeft: '3px solid var(--accent)', marginLeft: 4 }}>&nbsp;</span>
              </span>
            </div>
            <p className="animate-fade-up delay-300" style={{ color: 'var(--muted)', fontSize: 19, lineHeight: 1.85, maxWidth: 540, marginBottom: 52 }}>
            ...
            <div className="animate-fade-up delay-400" style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
              <button onClick={() => onNav('Projects')}
                style={{ padding: '18px 40px', borderRadius: 14, background: 'linear-gradient(135deg, var(--accent), var(--accent3))', border: 'none', color: '#fff', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17, cursor: 'pointer', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', boxShadow: '0 8px 24px rgba(79,126,248,0.30)' }}
                onMouseEnter={e => { e.target.style.transform = 'translateY(-3px) scale(1.02)'; e.target.style.boxShadow = '0 14px 36px rgba(79,126,248,0.45)' }}
                onMouseLeave={e => { e.target.style.transform = 'none'; e.target.style.boxShadow = '0 8px 24px rgba(79,126,248,0.30)' }}>
                Explore My Work
              </button>
              <a href="mailto:visvesvaran62@email.com" style={{ padding: '18px 40px', borderRadius: 14, background: 'transparent', border: '2px solid var(--border-subtle)', color: 'var(--text)', fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: 17, cursor: 'pointer', textDecoration: 'none', transition: 'all 0.3s', display: 'inline-block' }}
                onMouseEnter={e => { e.target.style.borderColor = 'var(--accent)'; e.target.style.background = 'rgba(79,126,248,0.06)' }}
                onMouseLeave={e => { e.target.style.borderColor = 'var(--border-subtle)'; e.target.style.background = 'transparent' }}>
                Contact Me
              </a>
            </div>
          </div>
          ...
          <div className="animate-float" style={{ position: 'relative' }}>
            <div style={{ position: 'relative', width: '100%', aspectRatio: '0.85', borderRadius: '30px', overflow: 'hidden', border: '1px solid rgba(79,126,248,0.15)', boxShadow: '0 24px 72px rgba(15,23,42,0.14)', transition: 'transform 0.5s cubic-bezier(0.2, 0.8, 0.2, 1)' }}
              onMouseMove={e => {
            ...
            <div style={{ position: 'absolute', top: '10%', right: '-10%', padding: '12px 20px', borderRadius: 12 }} className="glass animate-float delay-100"><span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent)', fontWeight: 600 }}>MongoDB</span></div>
            <div style={{ position: 'absolute', bottom: '20%', left: '-15%', padding: '12px 20px', borderRadius: 12 }} className="glass animate-float delay-500"><span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent)', fontWeight: 600 }}>React.js</span></div>
            <div style={{ position: 'absolute', top: '50%', right: '-15%', padding: '12px 20px', borderRadius: 12 }} className="glass animate-float delay-200"><span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent)', fontWeight: 600 }}>Node.js</span></div>
            <div style={{ position: 'absolute', inset: -30, borderRadius: 40, background: 'radial-gradient(circle, rgba(79,126,248,0.12) 0%, transparent 70%)', zIndex: -1, filter: 'blur(40px)' }} />
          </div>
        </div>
  ...
  return (
    <section id="About" ref={ref} style={{ padding: '120px 48px' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', width: '100%' }}>
        ...
        <p className={inView ? 'animate-fade-up delay-100' : ''} style={{ color: 'var(--muted)', lineHeight: 1.9, marginBottom: 22, fontSize: 17 }}>
        ...
        <p className={inView ? 'animate-fade-up delay-200' : ''} style={{ color: 'var(--muted)', lineHeight: 1.9, marginBottom: 40, fontSize: 17 }}>
        ...
        <div className={inView ? 'animate-fade-up delay-300' : ''} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            ...
            <div key={item.label} style={{ display: 'flex', gap: 16, alignItems: 'baseline' }}>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent)', minWidth: 90, letterSpacing: '0.05em', fontWeight: 600 }}>{item.label}</span>
              <span style={{ color: 'var(--muted)', fontSize: 14 }}>—</span>
              <span style={{ fontSize: 16, color: 'var(--text)', fontWeight: 500 }}>{item.val}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24, marginBottom: 60 }}>
          {Object.entries(SKILLS).map(([cat, items], ci) => (
            <div key={cat} className={`glass ${inView ? `animate-fade-up delay-${ci * 100 + 100}` : ''}`}
              ...
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent)', letterSpacing: '0.12em', marginBottom: 22, textTransform: 'uppercase', fontWeight: 600 }}>
                {cat}
              </div>
              {items.map((s, i) => (
                <div key={s.name} style={{ marginBottom: 16 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent)', fontWeight: 600 }}>{s.level}%</span>
                  </div>
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 40 }}>
              <div>
                ...
                <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 32, letterSpacing: '-0.02em', color: 'var(--text)', marginBottom: 6 }}>{p.title}</h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
                  {p.highlights.map(h => (
                    <div key={h} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <span style={{ fontSize: 15, color: 'var(--text)', fontWeight: 500 }}>{h}</span>
                    </div>
                  ))}
                </div>
                  ...
                  {p.tags.map(t => {
                    ...
                    return (
                      <span key={t} style={{
                        ...
                        color: tag.color, letterSpacing: '0.04em', fontWeight: 500,
                      }}>{tag.label}</span>
                    )
                  })}
                </div>
    ...
    <section id="Education" ref={ref} style={{ padding: '120px 48px', background: 'var(--surface)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {EDU.map((e, i) => (
                <div key={e.degree} className={`glass ${inView ? `animate-fade-up delay-${i * 200 + 100}` : ''}`}
                  ...
                  <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 20, color: 'var(--text)', marginBottom: 6, letterSpacing: '-0.01em' }}>{e.degree}</h3>
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: 14, color: e.color, marginBottom: 6, fontWeight: 600 }}>{e.school}</div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 }}>
                    <span style={{ fontSize: 14, color: 'var(--muted)', fontWeight: 500 }}>{e.period}</span>
                    <span style={{
                      fontFamily: 'var(--font-mono)', fontSize: 13, padding: '5px 14px',
                      background: `${e.color}15`, border: `1px solid ${e.color}30`,
                      borderRadius: 6, color: e.color, fontWeight: 600,
                    }}>CGPA {e.cgpa}</span>
                  </div>
                </div>
              ))}
          ...
          <div>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--accent2)', letterSpacing: '0.12em', marginBottom: 28, textTransform: 'uppercase', fontWeight: 600 }}>Certifications</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {CERTS.map((c, i) => (
                <div key={c.title} className={`glass ${inView ? `animate-fade-up delay-${i * 150 + 200}` : ''}`}
                  ...
                  <div style={{ flex: 1 }}>
                    <h4 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17, color: 'var(--text)', marginBottom: 5 }}>{c.title}</h4>
                    <div style={{ fontSize: 15, color: 'var(--muted)', marginBottom: 7 }}>{c.issuer}</div>
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: 12.5, color: c.color, fontWeight: 600 }}>{c.period}</span>
                  </div>
                </div>
              ))}
            </div>
...
function Contact() {
  ...
  const inputStyle = (focused) => ({
    ...
    background: 'var(--surface2)', border: `1px solid ${focused ? 'var(--accent)' : 'var(--border-subtle)'}`,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[
              ...
              <div key={item.label} className="glass" style={{ padding: '18px 22px', display: 'flex', gap: 16, alignItems: 'center' }}>
                ...
                <div>
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: 12, color: 'var(--muted)', letterSpacing: '0.08em', marginBottom: 4, fontWeight: 500 }}>{item.label}</div>
                  {item.href ? (
                    <a href={item.href} style={{ fontSize: 16, color: 'var(--accent)', textDecoration: 'none', fontWeight: 500 }}
        ...
        <div className={`glass-accent ${inView ? 'animate-fade-up delay-200' : ''}`} style={{ padding: '40px 44px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <button type="submit" style={{
              ...
              background: sent ? 'rgba(34,197,94,0.12)' : 'linear-gradient(135deg, var(--accent2), var(--accent))',
              border: sent ? '1px solid rgba(34,197,94,0.35)' : 'none',
              color: sent ? '#15803d' : '#ffffff',
              fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17,
              cursor: 'pointer', transition: 'all 0.3s',
              boxShadow: sent ? 'none' : 'var(--shadow-accent)',
            }}>
    ...
    <footer style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 28, flexWrap: 'wrap' }}>
              {[
                ...
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                  style={{ fontFamily: 'var(--font-mono)', fontSize: 15, color: 'var(--muted)', textDecoration: 'none', transition: 'color 0.2s', fontWeight: 500 }}
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: 32, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14, textAlign: 'center' }}>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 14, color: 'var(--muted)', fontWeight: 500 }}>
